...
parser.add_argument("--path", default="../yolov3/coco/images/FLIR_Dataset/video/Annotations/", help='Directory of json files containing annotations')
parser.add_argument("--output_path", default="./flir/video/", help='Output directory for image.txt files')
    ...
    with open(json_file) as f:
        ...
        for i in range(0, len(images)):
            ...
            for ann in annotations:
                if int(ann['image_id']) == i and int(ann['category_id']) <= 3:
