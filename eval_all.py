...
def get_image_txt_name(imagefile):
    #return imagefile.replace('../../../../data/datasets/KAIST_MPD/rgbt-ped-detection/data/kaist-rgbt/images', './kaist/annotations').replace('.jpg', '.txt').replace(
     #           '.jpg', '.txt').replace('../../../../data/datasets/FLIR_ADAS/FLIR_ADAS/training/PreviewData',
    ...
    return imagefile.replace('/Data/', '/labels/').replace('.jpeg', '.txt').replace('/Data_randaug/','/labels/').replace('/Data_aug/','/labels/').replace('/Data_with_gan/','/labels/').replace('/scene/','/labels/').replace('/dataset_sequenze/','/labels/')
